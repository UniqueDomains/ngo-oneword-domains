...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/ngo?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_ngo_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/ngo?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_ngo_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./ngo.csv">CSV</a> / <a href="./ngo.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_ngo_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_ngo_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .NGO search](https://unique.domains/domains/tld/ngo?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_ngo_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .NGO search](https://unique.domains/domains/tld/ngo?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_ngo_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./ngo.csv) or [Download JSON](./ngo.json)
...
- `ngo.csv` — public CSV extract (9,403 rows)
- `ngo.json` — public JSON extract (9,403 rows)
...
| bridge.ngo     | available | $16.99    | —             | 68             | 50     | 6      | name.com    |
...
> Unique Domains. *Available .NGO One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
